...
#define betaDef         0.605f            // 2 * proportional gain
...
void MadgwickAHRS::update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz,float deltaT) {
	float recipNorm;
	float s0, s1, s2, s3;
...
void MadgwickAHRS::updateIMU(float gx, float gy, float gz, float ax, float ay, float az,float deltaT) {
	float recipNorm;
	float s0, s1, s2, s3;
	float qDot1, qDot2, qDot3, qDot4;
